...
const Footer = () => {
    ...
    const connectObj = [
        ...
        { name: 'WhatsApp', value: 2, url: 'https://wa.me/7037338818?text=Hello%20I%20am%20interested%20in%20your%20service', icon: <IoLogoWhatsapp className=" text-black text-3xl hover:scale-125 cursor-pointer" /> },
        { name: 'Instagram', value: 3, url: 'paste your instagram url', icon: <RiInstagramFill className=" text-black text-3xl hover:scale-125 cursor-pointer" /> },
    ]
        ...
        <div id="works" className=" mx-auto m-auto h-[300px]  mt-16 sm:h-[250px]">
            <div className=" bg-yellow-400 h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
                ...
                <div className="sm:text-[12px]">
                    | Copyright &copy; <span>2024 Deksha </span> All rights reserved
                    <a href="#"></a> |
                </div>
            </div>
        </div>
